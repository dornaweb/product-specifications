                        ...
                        if( sizeof( $groups ) > 0 ) :
                            ...
                            <tr>
                                ...
                                <td class="dwps-actions">
                                    ...
                                    <?php
                                    echo '<a class="view" href="'. esc_url(add_query_arg( array( 'group_id' => $group->term_id, 'page' => 'dw-specs-attrs' ), esc_url( admin_url('admin.php') ) )) .'"><i class="dashicons dashicons-visibility"></i></a>'; ?>
