...
<div class="dwps-page">
    <div class="dwps-settings-wrap">
        <h3><?= esc_html__('Product specifications general settings', 'product-specifications') ?></h3>
        <p class="title-note"></p>

        <div class="dwps-box-wrapper dwps-box-padded clearfix">
            <div class="dwps-box-top clearfix">
                <h4><?= esc_html__('settings', 'product-specifications') ?></h4>
            </div><!-- .dwps-box-top -->
            ...
            <form method="post" action="options.php">
                ...
                <p class="dwps-field-wrap">
                    <strong class="label"><?= esc_html__('Views per page', 'product-specifications') ?></strong>
                    <em class="note"><?= esc_html__('How many records should be seen in a page?', 'product-specifications') ?></em>
                    <input type="number" name="dwps_view_per_page" value="<?= esc_attr(get_option('dwps_view_per_page')) ?>">
                </p>
                ...
                <p class="dwps-field-wrap">
                    <strong class="label"><?= esc_html__('Disable plugin\'s CSS styles', 'product-specifications') ?></strong>
                    <label>
                        <input type="checkbox" name="dwps_disable_default_styles" <?php checked(get_option('dwps_disable_default_styles'), 'on') ?>>
                        <?= esc_html__('Disable plugin\'s CSS styles', 'product-specifications') ?>
                    </label>
                </p>
