        ...
        <div class="dwps-box-wrapper clearfix">
            ...
            <div id="dwps_table_wrap">
                <table class="dwps-table" id="dwps_table">
                    ...
                    <tr>
                        ...
                        <th>
                            <?= esc_html__('ID', 'product-specifications') ?>
                        </th>
                        <th>
                            <?= esc_html__('Group name', 'product-specifications') ?>
                        </th>
                        <th>
                            <?= esc_html__('Group slug', 'product-specifications') ?>
                        </th>
                        <th>
                            <?= esc_html__('# of attributes', 'product-specifications') ?>
                        </th>
                        <th>
                            <?= esc_html__('Actions', 'product-specifications') ?>
                        </th>
                    </tr>
                    </thead>
                            ...
                            <tr>
                                <td class="check-column">
                                    <input
                                        ...
                                        name="slct_group[]"
                                        value="<?= esc_attr($group->term_id) ?>"
                                    />
                                </td>
                                <td>
                                    <?= esc_html($group->term_id) ?>
                                </td>
                                <td>
                                    <h4>
                                        <a
                                            ...
                                            data-type="group"
                                            data-action="edit"
                                            data-id="<?= esc_attr($group->term_id) ?>"
                                        >
                                            <?= esc_html($group->name) ?>
                                        </a>
                                    </h4>
                                ...
                                <td class="dwps-actions">
                                    ...
                                    <a href="#" class="re-arange" data-id="<?= esc_attr($group->term_id) ?>"><i class="dashicons dashicons-sort"></i></a>
                                </td>
                            </tr>
                            <?php
                        endforeach;
            ...
            <div class="dwps-buttons clearfix">
                <a
                    ...
                    href="#"
                    role="button"
                    aria-label="<?= esc_attr__('delete Selected attributes', 'product-specifications') ?>"
                    disabled
                >
                    <?= esc_html__('Delete Selected', 'product-specifications') ?>
                </a>

                <a data-dwpsmodal="true" id="dpws_add_new_btn" class="dwps-button add-new-btn" href="#" role="button" aria-label="<?= esc_attr__('Add a new group', 'product-specifications') ?>"><?= esc_html__('Add new', 'product-specifications') ?></a>
...
<script id="dwps_delete_template" type="x-tmpl-mustache" data-templateType="JSON">
    {
        "data" : {
            ...
            "nonce" : "<?= esc_attr(wp_create_nonce('dwps_modify_groups')) ?>"
        },
        "modal" : {
            "title" : "<?= esc_html__("Delete Attribute", "product-specifications") ?>",
            "content" : "<?= esc_html__("Are you sure you want to delete selected attribute(s)?", "product-specifications") ?>",
            "buttons" : {
                "primary": {
                    "value": "<?= esc_html__("Yes", "product-specifications") ?>",
                    "href": "#",
                    "className": "modal-btn btn-confirm btn-warn"
                },
                "secondary": {
                    "value": "<?= esc_html__("No", "product-specifications") ?>",
...
<script id="dwps_texts_template" type="x-tmpl-mustache">
    {
        ...
        "add_title"   : "<?= esc_attr__('Add new group', 'product-specifications') ?>",
        "edit_title"  : "<?= esc_attr__('Edit group', 'product-specifications') ?>",
        "re_arrange"  : "<?= esc_attr__('Re arrange attributes', 'product-specifications') ?>"
    }
</script>
...
<script id="modify_form_template" type="x-tmpl-mustache">
    <form action="#" method="post" id="dwps_modify_form">
        ...
        <p>
            ...
            <input type="text" name="group_slug" value="" id="group_slug" placeholder="<?= esc_attr__('Optional', 'product-specifications') ?>">
        </p>

        <p>
            <label for="group_desc"><?= esc_html__('Description : ', 'product-specifications') ?></label>
            <textarea name="group_desc" id="group_desc" placeholder="<?= esc_attr__('Optional', 'product-specifications') ?>"></textarea>
        </p>
    ...
    <input type="submit" value="<?= esc_attr__('Add Group', 'product-specifications') ?>" class="button button-primary">
    </form>
</script>
